"""
    ...
    optimized running time: 1 loop, best of 3: 1min 22s per loop
    RANKING: 2nd
    R = 1.13
"""
import timeit
...
def nbody(loops, reference, iterations):
    ...
    for _ in range(loops):
        ...
        for _ in range(iterations):
            advance(0.01, combs)
        print(report_energy(combs))

if __name__ == '__main__':
    %timeit nbody(100, 'sun', 20000)
